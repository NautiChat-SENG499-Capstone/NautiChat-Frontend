...
export function ChatSidebar({
  ...
  return (
    <>
      ...
      <div
        className={`hidden md:flex flex-col h-full bg-cyan-600 text-white transition-all duration-300 ${
      ...
      >
        ...
        {!isCollapsed && (
          <Button
            ...
            disabled={isLoading}
            variant="ghost"
            className="w-full justify-start text-white hover:bg-white/20 mb-2 px-4"
          >
            <Plus className="h-4 w-4 mr-2" />
            New Chat
          </Button>
